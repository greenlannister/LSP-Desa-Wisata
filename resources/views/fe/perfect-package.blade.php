            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-image">
                        <img class="img-fluid" src="{{ asset('fe/images/services-1.jpg') }}" alt="alternative">
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-image">
                        <img class="img-fluid" src="{{ asset('fe/images/services-2.jpg') }}" alt="alternative">
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-image">
                        <img class="img-fluid" src="{{ asset('fe/images/services-3.jpg') }}" alt="alternative">
                    </div>
                    <div class="card-body">
