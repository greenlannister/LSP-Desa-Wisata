            ...
            <div class="col-lg-12">
                ...
                <div class="team-member">
                    <div class="image-wrapper">
                        <img class="img-fluid" src="{{ asset('fe/images/team-1.png') }}" alt="alternative">
                ...
                <div class="team-member">
                    <div class="image-wrapper">
                        <img class="img-fluid" src="{{ asset('fe/images/team-2.png') }}" alt="alternative">
                    </div> <!-- end of image wrapper -->
                ...
                <div class="team-member">
                    <div class="image-wrapper">
                        <img class="img-fluid" src="{{ asset('fe/images/team-3.png') }}" alt="alternative">
                    </div> <!-- end of image wrapper -->
                ...
                <div class="team-member">
                    <div class="image-wrapper">
                        <img class="img-fluid" src="{{asset ('fe/images/team-4.png') }}" alt="alternative">
                    </div> <!-- end of image wrapper -->
