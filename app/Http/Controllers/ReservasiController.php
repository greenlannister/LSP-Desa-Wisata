...
class ReservasiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Cek ketersediaan tanggal dan kapasitas
        ...
        if ($kapasitasTersedia < $request->jumlah_peserta) {
            return back()->withErrors([
                'jumlah_peserta' => 'Kapasitas tidak mencukupi. Hanya tersisa ' . $kapasitasTersedia . ' slot, coba tanggal lain atau paket lain',
                'tgl_mulai_reservasi' => 'Tanggal yang dipilih sudah penuh', // Tambahkan ini
                'tgl_selesai_reservasi' => 'Tanggal yang dipilih sudah penuh' // Tambahkan ini
            ])->withInput();
        }
        ...
        if ($request->id_diskon) {
            ...
            $nilaiDiskon = ($paket_wisata->harga_per_pack * $request->jumlah_peserta) * ($persentaseDiskon / 100);
        }
        
        // Hitung subtotal dan total
        $subtotal = $paket_wisata->harga_per_pack * $request->jumlah_peserta;
        ...
        $reservasi = Reservasi::create([
            ...
            'harga' => $paket_wisata->harga_per_pack,
